...
export default function Card({id, project}) {
    return (<>
        <div className="w-[30%] h-[45vh] border border-gray-200 rounded-lg p-2 bg-[#F1F1F1] shadow-sm hover:shadow-md  transition-shadow duration-300 max-sm:w-full max-sm:h-[30vh] max-[380px]:h-[40vh]">

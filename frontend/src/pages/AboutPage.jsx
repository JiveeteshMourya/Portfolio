    ...
    return (<>
        ...
        <div className="flex flex-row bg-[#ECf0F1] max-sm:flex-col-reverse">
            ...
            <div className="basis-1/3 p-4 max-sm:basis-3/3">
                <img src="./assets/JCodeLogo.png" className="object-cover h-[40%] mb-6"/>

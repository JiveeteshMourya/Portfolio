        ...
        <div className="bg-gray-200">
            ...
            <div className="leading-loose p-6 bg-white shadow-md rounded-lg mt-6 mx-auto max-w-4xl">
                ...
                {project.links.live && <>
                    ...
                    <a id="live" href={project.links.live} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
                        <i className="fa-solid fa-external-link"></i> {project.links.live}
                    </a>
                </>}
                <p className="mt-4"></p>
                <label htmlFor="github" className="font-semibold">GitHub: &nbsp;</label>
                <a id="github" href={project.links.github} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
